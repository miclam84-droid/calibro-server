...
def genera_ricetta(db, richiesta, disciplina="cucina", lang="it"):
    ...
    prompt = (
        ...
        f"- LIEVITATI (pizza, pane, focaccia, brioche): i 'numeri' DEVONO includere SEMPRE il tempo di "
        f"lievitazione REALISTICO e l'idratazione. La lievitazione è il parametro PIÙ importante: una "
        f"pizza napoletana lievita 8-24h (spesso 24-48h con biga/poolish), MAI 2 ore. Il pane 3-24h. "
        f"Dare tempi VERI da professionista: 'lievitazione: 8-24h a 18-22°C', 'idratazione: 60-65%'. "
        f"NON dare mai lievitazioni brevi irrealistiche (1-2h) per pizza/pane: è l'errore che fa capire "
        f"a un pizzaiolo che l'app non sa il mestiere.\n"
