...
def genera_ricetta(db, richiesta, disciplina="cucina", lang="it"):
    ...
    prompt = (
        ...
        f'"procedimento": [{{"n": 1, "testo": "passaggio operativo chiaro e specifico", "numero_chiave": "es. 80-85°C oppure null se il passo non ha un numero critico"}}], '
        f'"applicazioni": ["dove si usa questa preparazione, es. lasagne, gratin", ...], '
        ...
        f"Il PROCEDIMENTO deve essere una sequenza di passaggi REALI e specifici (non generici): "
        f"ogni passo che tocca un parametro critico DEVE avere il numero_chiave preso dai fenomeni sopra "
        f"(es. temperatura, tempo, pH). I passi senza numero critico hanno numero_chiave null. "
        f"Le APPLICAZIONI dicono dove si usa la preparazione nel mestiere. "
