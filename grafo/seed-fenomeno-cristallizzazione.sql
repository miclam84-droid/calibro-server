...
('fen-cristallizzazione', 'Fenomeno', 'Cristallizzazione', 'trasversale',
 '{"tipo":"fisico-chimico",
   ...
   "strumento":"termometro di precisione ±0,1°C",
   "scheda":"La cristallizzazione è il processo per cui le molecole di un liquido raffreddato si organizzano in strutture solide ordinate. In pasticceria è il fenomeno più critico: il burro di cacao ha sei forme cristalline diverse (Forma I-VI), e solo la Forma V β produce il cioccolato temperato corretto — quello che suona, brilla e si spezza netto. Scaldando il cioccolato oltre 45°C si sciolgono tutti i cristalli. Raffreddando a 27-28°C si formano cristalli instabili (Forma IV). Portando di nuovo a 31-32°C rimangono solo i cristalli Forma V: questo è il temperaggio. Lo stesso principio governa la cristallizzazione del burro (burro pomata vs burro granuloso) e dello zucchero (fondente, caramello, pralinato).", "principio":"Il burro di cacao cristallizza in sei forme polimorfe con punti di fusione diversi. Solo la Forma V produce il cioccolato con snap, lucentezza e punto di fusione leggermente sotto la temperatura corporea (32°C). Il temperaggio è il processo controllato di formazione di cristalli Forma V come nuclei di cristallizzazione: si porta il cioccolato fuso a ~50°C (scioglie tutto), poi a 27-28°C (formazione di cristalli misti), poi a 31-32°C (scioglie i cristalli instabili, restano solo i Forma V). Lavorare fuori da questa finestra di temperatura produce cioccolato con fioritura (bloom bianca = forma VI instabile). Nello zucchero cotto, la cristallizzazione è il nemico: acido e glucosio la prevengono."}')
