...
('fen-distillazione', 'Fenomeno', 'Distillazione', 'bar',
 '{"tipo":"fisico",
   ...
   "strumento":"termometro · alcolimetro (idrometro)",
   "scheda":"La distillazione separa l alcol dall acqua sfruttando i diversi punti di ebollizione: l etanolo bolle a 78,4C, l acqua a 100C. Riscaldando il fermentato, l etanolo evapora prima, sale nell alambicco, si condensa e si raccoglie piu concentrato. Il distillatore fa tre tagli. Le teste escono per prime: contengono metanolo (64,7C, tossico) e acetone, sanno di solvente, si scartano o si ri-distillano. Il cuore e la parte buona: etanolo puro con gli esteri aromatici del fermentato, esce a 65-75% ABV. Le code escono per ultime: fusel oils e congeners pesanti a punto di ebollizione alto, danno note oleose e amare, si riciclano nella culla successiva. La qualita di un distillato dipende quasi interamente da quanto e quando si fanno i tagli. La distillazione poi porta il distillato al 40-60% ABV finale con acqua demineralizzata, e non produce alcol: lo concentra. L alcol lo fa la fermentazione che viene prima."}');
