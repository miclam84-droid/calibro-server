...
('fen-denaturazione', 'prod-bistecca', 'si_manifesta_in',
...
('fen-denaturazione', 'prod-uova', 'si_manifesta_in',
...
('fen-denaturazione', 'prod-creme-pasticceria', 'si_manifesta_in',
...
('fen-denaturazione', 'prod-pane-lievitazione', 'si_manifesta_in',
...
('fen-denaturazione', 'fen-coagulazione', 'influenza',
 '{"nota":"La denaturazione è il processo molecolare; la coagulazione è il risultato visibile (il liquido diventa solido). Denaturazione precede sempre la coagulazione"}');
