...
('fen-acidita', 'Fenomeno', 'Acidità', 'trasversale',
 '{"tipo":"fisico-chimico","numero_bersaglio":"pH · acidità titolabile % — sour 1,0-1,5% · madre pH 3,7-3,9 · gel confettura pH 3,0-3,3","scheda":"L''acidità è la stessa grandezza fisica in tre mestieri: protoni liberi (pH) e quantità totale di acido (titolabile). Al banco bilancia un sour, in pentola fa rapprendere un gel, al forno fa da orologio alla madre. Una primitiva, tre stanze."}');
