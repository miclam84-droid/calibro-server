...
('fen-crioscopia', 'Fenomeno', 'Abbassamento crioscopico', 'trasversale',
 '{"tipo":"fisico-chimico",
   ...
   "scheda":"L acqua pura congela a 0C, ma i soluti disciolti abbassano quel punto: e la stessa fisica del sale sulle strade d inverno. Nel gelato lo zucchero e il regista della cremosita. Ogni zucchero ha un potere anticongelante (PAC): sucrosio = 100 di riferimento, destrosio ~175, fruttosio ~180, lattosio 100. Sommando i PAC del mix si ottiene quanta acqua resta liquida a una data temperatura. Un PAC totale intorno a 280-320 tiene il gelato morbido e scavabile a -12C.", "principio":"Il punto di congelamento di una soluzione scende in funzione della concentrazione dei soluti disciolti — è l''abbassamento crioscopico. Nel gelato, il PAC (Potere Anti-Congelante) misura la capacità degli zuccheri di tenere il gelato morbido alla temperatura di servizio. Saccarosio, glucosio, fruttosio e trealosio hanno PAC diversi: bilanciare la miscela di zuccheri permette di controllare la consistenza finale senza cambiare la dolcezza. Un PAC troppo basso produce un gelato duro come un mattone a -12°C; troppo alto rimane molliccio. Stessa logica governa la ricettazione di sorbetti e semifreddi. È il calcolo più critico nella gelateria artigianale."}')
