...
('fen-calore', 'Fenomeno', 'Calore / cinetica termica', 'trasversale',
 '{"scheda":"La temperatura governa due cose: la VELOCITÀ delle reazioni (raddoppia ogni ~8-10°C, è il Q10) e i CAMBI DI STATO (sciogliere, vaporizzare, che costano calore latente). È la stessa fisica sotto il ghiaccio che si scioglie, l''impasto che lievita e la carne che pastorizza."}');
