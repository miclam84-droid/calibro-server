...
-- BAR
('fen-concentrazione', 'prod-sciroppo', 'si_manifesta_in',
...
('fen-concentrazione', 'prod-sour', 'si_manifesta_in',
...
('fen-concentrazione', 'prod-filtro', 'si_manifesta_in',
...
-- BAKERY
('fen-concentrazione', 'prod-impasto', 'si_manifesta_in',
