...
('fen-lievitazione-chimica', 'Fenomeno', 'Lievitazione chimica', 'trasversale',
 '{"tipo":"fisico-chimico",
   ...
   "strumento":"bilancia (dosaggio) · pH-metro (bilanciamento acido-base)",
   "scheda":"Fa crescere l impasto senza lieviti vivi: e una reazione acido-base che libera CO2 appena il bicarbonato incontra un acido e l acqua. E cosa diversa dalla fermentazione (che e biologica, coi lieviti) e dalla carbonatazione (CO2 disciolta sotto pressione). Il numero che governa e il bilancio: quanto acido serve per neutralizzare il bicarbonato e ottenere un pH neutro. Se metti troppa soda senza abbastanza acido, la mollica vira al giallo e sa di sapone; il valore neutralizzante (NV) dice esattamente quanto acido serve. Il lievito chimico a doppia azione e furbo: libera circa il 15% del gas gia a freddo, in impasto, e l 85% in forno col calore, cosi la spinta arriva quando serve. Dosaggio tipico 1-2% sul peso della farina."}');
