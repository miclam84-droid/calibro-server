...
('fen-gelatinizzazione', 'Fenomeno', 'Gelatinizzazione amido', 'trasversale',
 '{"tipo":"fisico-chimico",
   ...
   "strumento":"termometro",
   "scheda":"I granuli di amido sono strutture semicristalline che a temperatura ambiente non assorbono acqua facilmente. Riscaldati in presenza di acqua, i legami cristallini si rompono: i granuli assorbono acqua, si gonfiano, si rompono e le catene di amilosio e amilopectina si disperdono nel liquido formando un gel. È irreversibile. Temperature diverse per amidi diversi — questo spiega perché la salsa di mais addensa prima di quella di patata. La quantità di acqua disponibile è critica: con poca acqua (biscotti) l'amido gelatinizza parzialmente; con tanta acqua (creme) gelatinizza completamente. Il raffreddamento successivo produce retrogradazione."}');
