"""admin_legacy.py — endpoint di migrazione/seed/test GIA' ESEGUITI, archiviati.
NON registrato in app.py: le route non sono attive. Codice conservato per recupero.
Per riattivare temporaneamente: registrare bp_legacy in app.py.
"""
from flask import request, jsonify
import os, hmac, json
try:
    from flask import Blueprint
    bp_legacy = Blueprint("admin_legacy", __name__)
    bp = bp_legacy  # gli endpoint usano @bp.route
except Exception:
    bp = None
# helper condivisi (import lazy dentro le funzioni dove servono)
