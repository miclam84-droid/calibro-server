...
def _fenomeno_a_scheda(dd, nome, nid):
    ...
    return {
        ...
        "stato_editoriale": dd.get("stato_editoriale") or "ai_generated",
        "confidenza": (dd.get("provenienza",{}) or {}).get("confidenza") or "",
        ...
        "target_chips": dd.get("target_chips") or [],
        "scheda": dd.get("scheda") or cs.get("spiegazione") or cs.get("principio") or dd.get("risposta_cache_it") or "",
        "principio": cs.get("principio") or dd.get("principio") or dd.get("scheda") or "",
        "cosa_sapere": (cs.get("spiegazione") or dd.get("scheda") or cs.get("principio") or dd.get("risposta_cache_it") or "")[:280],
        "punto_critico": cs.get("punto_critico") or dd.get("punto_critico") or cs.get("errore_critico") or "",
