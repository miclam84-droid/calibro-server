...
SCHEDE_SCIENZA = {
    ...
    "brodo": {
        "nome": "Brodo / Fondo (base madre)",
        "categoria": "base",
        "fenomeno": "Estrazione di gelatina (dal collagene delle ossa), proteine e aromi in acqua a bassa temperatura prolungata.",
        "principio": "Il collagene di ossa e cartilagini si scioglie lentamente in gelatina, che da' corpo. La cottura DOLCE (mai bollore) evita che grassi e proteine si emulsionino intorbidendo il brodo. La tostatura delle ossa (per il fondo bruno) aggiunge Maillard.",
        "numero_bersaglio": "Sobbollire appena, 85-90°C, per 4-8h (ossa) o 1h (verdure)",
        "punto_critico": "Bollore → brodo torbido e grasso (le proteine coagulano male e i grassi si emulsionano). Salare troppo presto → si concentra e diventa salato riducendo.",
        "segnale_reale": "Superficie che tremola appena, non ribolle. Limpido. Da freddo GELIFICA (segno di collagene estratto). Schiumare le impurita' in superficie.",
        "tecnica": "Partire da acqua fredda (estrae meglio), portare piano, schiumare, sobbollire scoperto. Fondo bruno: tostare ossa e verdure prima. Filtrare.",
        "errori_comuni": "Bollore → torbido. Partenza acqua calda → meno estrazione. Non schiumare → sporco. Sale presto → troppo salato a fine riduzione.",
    },
    "risotto": {
        "nome": "Risotto (tecnica della mantecatura)",
        "categoria": "base",
        "fenomeno": "Rilascio graduale dell'amido (amilosio) del riso che, legato a grasso freddo a fine cottura, crea la cremosita' (mantecatura).",
        "principio": "I chicchi (Carnaroli/Arborio) rilasciano amido durante la cottura mescolata col brodo caldo aggiunto poco a poco. A fine cottura, burro/formaggio FREDDI fuori dal fuoco emulsionano l'amido creando l'onda cremosa senza far separare i grassi.",
        "numero_bersaglio": "Cottura ~16-18min; mantecatura fuori dal fuoco a ~1min di riposo",
        "punto_critico": "Brodo freddo → blocca la cottura e slega. Mantecare sul fuoco → il grasso si separa (unto invece che cremoso). Riso scotto → si slega e diventa colla.",
        "segnale_reale": "All'onda: si muove come un'onda nel piatto, non compatto ne' brodoso. Chicco al dente con anima. Lucido dopo la mantecatura.",
        "tecnica": "Tostatura riso, sfuma, brodo caldo poco a poco mescolando, a fine cottura fuori dal fuoco burro+parmigiano freddi, riposo 1min, mantecare.",
        "errori_comuni": "Brodo freddo → slega. Mantecare sul fuoco → unto. Poco mescolato → cuoce male. Riso sbagliato → non tiene.",
    },
    "crema-pasticcera": {
        "nome": "Crema pasticcera (crema madre)",
        "categoria": "base/pasticceria",
        "fenomeno": "Addensamento doppio: coagulazione delle proteine del tuorlo + gelatinizzazione dell'amido, nel latte caldo.",
        "principio": "I tuorli coagulano a 65-70°C ma l'amido (amido/farina) alza la soglia di sicurezza e stabilizza, permettendo di portare a bollore senza stracciare le uova. L'amido gelatinizza e da' corpo.",
        "numero_bersaglio": "Portare a 82-85°C (con amido si puo' sfiorare il bollore)",
        "punto_critico": "Senza amido, sopra 70°C le uova stracciano (frittata dolce). Cottura insufficiente → sapore di amido crudo e crema che non tiene. Raffreddamento lento → rischio batterico.",
        "segnale_reale": "Vela il cucchiaio, poi al bollore si addensa di colpo. Lucida, senza grumi. Raffreddare veloce con pellicola a contatto.",
        "tecnica": "Tuorli+zucchero+amido, latte caldo a filo, sul fuoco mescolando fino a addensare oltre il velo. Pellicola a contatto, abbattere.",
        "errori_comuni": "Latte caldo di colpo sui tuorli → straccia. Poca cottura → amido crudo. Niente pellicola a contatto → crosta. Raffreddamento lento → si guasta.",
    },
    "meringa": {
        "nome": "Meringa (schiuma di albume)",
        "categoria": "base/pasticceria",
        "fenomeno": "Denaturazione delle proteine dell'albume che, montate, intrappolano aria in una schiuma stabilizzata dallo zucchero.",
        "principio": "Montando, le proteine dell'albume si aprono (denaturano) e formano pareti attorno alle bolle d'aria. Lo zucchero le stabilizza legando acqua e rendendo la schiuma lucida e ferma. Il grasso (anche una traccia di tuorlo) impedisce il montaggio.",
        "numero_bersaglio": "~2:1 zucchero:albume (francese); italiana con sciroppo a 121°C",
        "punto_critico": "Tracce di grasso/tuorlo → non monta. Zucchero troppo presto → non incorpora aria. Surriscaldata (italiana) → cuoce male; sovramontata → granulosa e collassa.",
        "segnale_reale": "Becco d'uccello: la punta ferma e lucida. Non scivola capovolgendo la ciotola. Liscia, non granulosa (zucchero sciolto).",
        "tecnica": "Francese: albumi a temp. ambiente, zucchero a pioggia dopo la schiuma. Italiana: sciroppo 121°C a filo. Ciotola sgrassata.",
        "errori_comuni": "Grasso nella ciotola → non monta. Zucchero subito → piatta. Sovramontata → collassa. Umidita' alta → smonta.",
    },
}
