...
def disciplina(nome):
    ...
    PRIORITA = {
        "bar":          ["fen-acidita","fen-diluizione","fen-concentrazione","fen-carbonatazione","fen-estrazione","fen-emulsione","fen-crioscopia","fen-osmosi","fen-ossidazione","fen-clarificazione-cocktail","fen-batch-cocktail","fen-texture-agents","fen-fat-washing"],
        "caffetteria":  ["fen-estrazione","fen-estrazione-caffe","fen-concentrazione","fen-pressione","fen-trasferimento-calore","fen-acidita","fen-attivita-enzimatica","fen-temperatura-latte"],
        "panificazione":["fen-acidita","fen-fermentazione","fen-fermentazione-lattica","fen-maglia-glutinica","fen-lievitazione","fen-crosta","fen-sale-impasto","fen-enzimi-farina","fen-shelf-life-pane","fen-gelatinizzazione","fen-retrogradazione","fen-concentrazione","fen-osmosi","fen-autolisi"],
        "cucina":       ["fen-maillard","fen-denaturazione","fen-coagulazione","fen-emulsione","fen-acidita","fen-osmosi","fen-trasferimento-calore","fen-punto-fumo","fen-cottura-sous-vide","fen-gelificazione"],
        "pasticceria":  ["fen-emulsione","fen-cristallizzazione","fen-caramellizzazione","fen-maillard","fen-gelatinizzazione","fen-denaturazione","fen-sineresi","fen-gelificazione"],
        "gelateria":    ["fen-crioscopia","fen-cristallizzazione-ghiaccio","fen-overrun","fen-concentrazione","fen-emulsione","fen-pac-gelateria","fen-stabilizzanti-gelato","fen-bilanciamento-gelato"],
        "vino":         ["fen-acidita","fen-malolattica","fen-ossidazione","fen-fermentazione","fen-tannini","fen-chiarificazione","fen-solforosa","fen-maturazione-legno","fen-estrazione-polifenoli","fen-rifermentazione"],
        "birra":        ["fen-fermentazione","fen-carbonatazione","fen-amilolisi","fen-acidita","fen-ossidazione","fen-attivita-enzimatica","fen-mash-enzimi","fen-isomerizzazione-luppolo","fen-dry-hopping","fen-lagering"],
    }
