...
_FEN_MIGRATI = {
    ...
    "fen-carbonatazione","fen-chiarificazione-latte","fen-infusioni","fen-amaro-bitter","fen-collagene-brasato","fen-rosolatura","fen-emulsione-salse","fen-ossidazione","fen-osmosi","fen-viscosita","fen-denaturazione",
