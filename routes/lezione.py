...
def disciplina(nome):
    ...
    PRIORITA = {
        ...
        "panificazione":["fen-acidita","fen-fermentazione","fen-fermentazione-lattica","fen-maglia-glutinica","fen-lievitazione","fen-crosta","fen-sale-impasto","fen-enzimi-farina","fen-shelf-life-pane","fen-poolish-biga","fen-laminazione","fen-gelatinizzazione","fen-retrogradazione","fen-concentrazione","fen-osmosi","fen-autolisi","fen-grassi-impasto","fen-zuccheri-impasto","fen-uova-impasto","fen-latte-impasto","fen-idratazione","fen-farina-forza","fen-temperatura-impasto"],
