...
const _strings = {
  it:{
    ...
    ct_sic_gate_btn:'Passa a Pro — €11,99/mese',
  },
  en:{
    ...
    ct_sic_gate_btn:'Upgrade to Pro — €11.99/month',
  },
  es:{
    payoff:'Science & Craft',
    ...
    ct_sic_gate_btn:'Mejorar a Pro — €11,99/mes',
    accedi:'Acceder',
    acido_citrico:'g de ácido cítrico.',
    aggiungi_acido:'Añadir',
    aggiungi_ing:'Añade un ingrediente.',
...
function mostraPopupPro(motivo){
  ...
  const _COPY = {
    it: {
      ...
      icon_chat: '',
      icon_lesson: '',
      title_esaurito: 'Hai usato le 5 chat gratuite',
      title_ultimo: 'Ultima chat gratuita',
      title_lezione: 'Fenomeno riservato a Pro',
      title_lezione_locked: 'Fenomeno riservato a Pro',
      sub_esaurito: 'Continua a usare la scienza del mestiere senza limiti.',
      sub_ultimo: 'Ancora una risposta e poi dovrai scegliere.',
      sub_lezione: 'I fenomeni avanzati sono disponibili con il piano Pro.',
      feat1: '∞  Chat illimitate con numeri reali',
      feat2: 'Tutti i fenomeni di ogni disciplina',
      feat3: '⊞  6 calcolatori senza restrizioni',
      feat4: 'Flavor Network completo',
      price: '€11,99',
      period: '/mese · Disdici quando vuoi',
      cta: 'Passa a Pro',
      skip_esaurito: 'Torna alla home',
