...
window._moduli = window._moduli || { chat:false, lezioni:false };
...
async function _caricaPostiFounding(){
  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load', ()=>{
      ...
      setTimeout(function(){ if(typeof _caricaModulo==='function'){ _caricaModulo('chat'); _caricaModulo('lezioni'); } }, 1200);
    });
  }
