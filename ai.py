...
def costruisci_prompt(domanda, contesto, lang="it"):
    ...
    if lang == "en":
        ...
        regole = (
            ...
            "\n\nCOME SCRIVI (prosa da consulente senior, NON template):\n"
            "Scrivi come un consulente chimico-alimentare e capopartita senior che parla a un altro "
            "professionista. Tono asciutto, analitico, denso, senza aggettivi commerciali. NON usare "
            "MAI etichette rigide in stampatello (niente PROBLEMA:, PERCHE:, NUMERO:, MISURA:, AZIONE:). "
            "La risposta fluisce come una spiegazione da manuale tecnico, in tre movimenti organici continui:\n"
            "1) L'analisi del fenomeno: identifica subito la causa fisica/molecolare reale (es. rottura "
            "dell'emulsione grasso-acqua nella mantecatura, degradazione dell'amido), col perche chimico "
            "e i termini scientifici corretti.\n"
            "2) Il punto di viraggio: fai emergere NEL TESTO il numero-bersaglio esatto come la soglia che "
            "governa tutto (es. sopra i 60 gradi il burro fonde e l'emulsione tiene). Il numero e il cardine "
            ...
            "10. Non inventare mai un numero: senza dato verificato, spiega il fenomeno senza cifre\n"
